...
class_ = None                   # replace with the classes of the dinos you want to filter for ex. [Dinos.basilisk, Dinos.reaper_queen]
lower_lvl = None                # replace with the lower level bound ex. 100
upper_lvl = None                # replace with the upper level bound ex. 150
tamed = None                    # replace with True or False to filter for tamed or wild dinos
...
save_path = Path.cwd() / "test_saves" / "Aberration_WP.ark" # replace with path to your save file
...
dinos: Dict[UUID, Dino] = dApi.get_all_filtered(level_lower_bound=lower_lvl,
                              ...
                              class_=class_,
                              tamed=tamed,
                              stat_point_requirement=stat_point_requirement,
                              stats=stats)
