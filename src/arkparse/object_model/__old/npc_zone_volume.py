from arkparse.parsing.struct.struct_val_check import check_uint32, check_byte, check_save_name
...
class NpcZoneVolume(ArkGameObject):
    ...
    def __init__(self, uuid: UUID, buffer: ArkBinaryParser):
        ...
        super().__init__(uuid, "/Script/ShooterGame.NPCZoneVolume", buffer)
