...
from arkparse.classes.equipment import Misc
    
def _get_weapon_dura(bp: str):
    if bp == Weapons.advanced.compound_bow:
        return 55
        ...
        print(f"WARNING: No durability found for weapon {bp}")
        return 0
