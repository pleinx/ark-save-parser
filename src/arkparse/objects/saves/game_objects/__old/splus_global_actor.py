from arkparse.struct.struct_val_check import check_uint32, check_byte, check_save_name, check_uint64
...
class SplusActorGlobal(ArkGameObject):
    ...
    def __init__(self, uuid: UUID, buffer: ArkBinaryParser):
        ...
        super().__init__(uuid, "/QoLPlus/SPlusGlobalActor.SPlusGlobalActor_C", buffer)
