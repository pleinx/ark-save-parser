...
class MapCoordinateParameters:
    ...
    def __init__(self, map: ArkMap):
        ...
        if map == ArkMap.SCORCHED_EARTH:
            ...
            self.playable_max_y = 408000.0
            self.playable_max_z = 54695.0
        elif map == ArkMap.GENESIS:
            self.origin_min_x = -1199686.7818074834
            self.origin_min_y = -1199158.2724965694
            self.origin_min_z = -15000.0
            self.origin_max_x = 1200093.3314276007
            self.origin_max_y = 1198407.7044710987
            self.origin_max_z = 54695.0
            self.playable_min_x = -1199686.7818074834
            self.playable_min_y = -1199158.2724965694
            self.playable_min_z = -15000.0
            self.playable_max_x = 1200093.3314276007
            self.playable_max_y = 1198407.7044710987
            self.playable_max_z = 54695.0
